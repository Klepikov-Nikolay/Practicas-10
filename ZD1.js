(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        createTodoApp(document.getElementById('todo'), 'Мои дела');
        createTodoApp(document.getElementById('todomom'), 'Дела мамы');
        createTodoApp(document.getElementById('tododad'), 'Дела папы');
    });
}) ();